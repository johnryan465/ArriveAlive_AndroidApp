...
public class RoutePlanner extends ActionBarActivity {
    public String data;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textStart = (AutoCompleteTextView)findViewById(R.id.Start);
        textDest   = (AutoCompleteTextView)findViewById(R.id.Destination);
        ...
        directions.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                shareIntent.putExtra(Intent.EXTRA_TEXT,directions.getText());
                shareIntent.putExtra(Intent.EXTRA_SUBJECT, "Directions");
