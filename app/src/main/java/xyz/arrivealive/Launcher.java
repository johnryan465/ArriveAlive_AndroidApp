...
public class Launcher extends Activity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(xyz.arrivealive.R.layout.launcher);
        Button routePlannerButton = (Button) findViewById(xyz.arrivealive.R.id.button1);
        ...
        Button navigatorButton = (Button) findViewById(xyz.arrivealive.R.id.button2);
